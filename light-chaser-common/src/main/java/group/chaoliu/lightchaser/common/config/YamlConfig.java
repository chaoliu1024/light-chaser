...
public class YamlConfig {
    ...
    public static Map readLightChaserConfig() {
        return YamlConfig.findAndReadConfigFile("light-chaser.yaml");
    }

    public static Map readProxyConfig() {
        Map lightChaserConfig = readLightChaserConfig();
        String proxyFile = lightChaserConfig.get(Constants.PROXY_FILE).toString().trim();
        return YamlConfig.readConfig(proxyFile);
    }

    public static Map readConfig(String fileName) {
        return YamlConfig.findAndReadConfigFile(fileName);
    }
