...
package group.chaoliu.lightchaser.core.filter;
 ...
 * <p>
 * For updates and bugfixes, see <a @href="http://github.com/magnuss/java-bloomfilter">Java-RAMBloomFilter</a>
 * <p>
 ...
 * <a @href="http://blog.locut.us/2008/01/12/a-decent-stand-alone-java-bloom-filter-implementation/">A decent stand-alone Java Bloom Filter implementation</a>
 *
 * @param <E> Object type that is to be inserted into the Bloom filter, e.g. String or Integer.
 * @author Magnus Skjegstad <magnus@skjegstad.com>
 */
public class RAMBloomFilter<E> implements BloomFilter<E>, Serializable {
     ...
     */
    public RAMBloomFilter(double c, int n, int k) {
     ...
     */
    public RAMBloomFilter(int bitSetSize, int expectedNumberOElements) {
     ...
     */
    public RAMBloomFilter(double falsePositiveProbability, int expectedNumberOfElements) {
     ...
     */
    public RAMBloomFilter(int bitSetSize, int expectedNumberOfFilterElements, int actualNumberOfFilterElements, BitSet filterData) {
     ...
     * The digest function is called until the required number of int's are produced.
    ...
    public boolean equals(Object obj) {
        ...
        final RAMBloomFilter<E> other = (RAMBloomFilter<E>) obj;
