...
import me.chaoliu.lightchaser.core.fission.proxy.mapper.ProxyMapper;
...
public class ProxyService {
    ...
    public void insertProxy(ProxyVO proxy) {
        proxyMapper.insertProxy(proxy);
    }

    public void batchInsertProxy(List<ProxyVO> proxies) {
